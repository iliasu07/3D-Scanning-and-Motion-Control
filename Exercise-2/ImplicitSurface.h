...
public:
	...
	{
		return (std::pow(_x.x() - m_center.x(), 2) + std::pow(_x.y() - m_center.y(), 2) + std::pow(_x.z() - m_center.z(), 2) - std::pow(m_radius, 2));
	}
...
public:
	...
	double Eval(const Eigen::Vector3d& _x)
	{
		...
		return (std::pow(std::pow(_x.x() - m_center.x(), 2) + std::pow(_x.y() - m_center.y(), 2) + std::pow(_x.z() - m_center.z(), 2) + std::pow(m_radius, 2) - std::pow(m_a, 2), 2) 
				- 4 * std::pow(m_radius, 2) * (std::pow(_x.x() - m_center.x(), 2) + std::pow(_x.y() - m_center.y(), 2)));
	}
